...
<h2 className='text-center mt-4   fw-bold text-white'>Digital Marketing & SEO</h2>
<p className="m-5 text-white">Are you extensively searching for the best facilitators of Digital Marketing Course and Advance Digital Marketing Course ? If yes, then your hunt for the same stops right at Pankaj Kumar SEO Expert. He is the most eminent Digital Marketing expert that you would ever attain. His training modules are designed in such a way that would impart rightful skill set when it comes to giving you a bright career in Digital Marketing.
...
<img
              id="img2"
              className="img rounded-circle float-start"
              src={whyus}
              alt="profile"
      ...
      <div className="col-md-7">
            <p className=" m-5 float-end text-justify text-white">
